...
.panel{display:none;padding:10px 14px 100px}.panel.on{display:block}
...
#bnav{position:fixed;bottom:8px;left:10px;right:10px;z-index:90;background:rgba(18,18,30,.96);border:1px solid rgba(255,215,0,.15);border-radius:20px;display:flex;padding:6px 4px;box-shadow:0 4px 24px rgba(0,0,0,.5),0 0 0 1px rgba(255,215,0,.05)}
...
.ubtabs{display:flex;gap:8px;padding:10px 0 4px;margin-bottom:2px}
.ubtab{flex:1;padding:12px;border-radius:12px;border:1.5px solid rgba(255,255,255,.1);background:var(--c1);color:var(--mt);font-family:'Nunito',sans-serif;font-size:13px;font-weight:800;cursor:pointer;transition:all .2s}
.ubtab.on{background:linear-gradient(135deg,rgba(255,100,0,.2),rgba(255,215,0,.1));border-color:rgba(255,215,0,.4);color:var(--gd)}
